  ...
  */
  ...
  public:
    ...
    */
    ...
    /** \brief Locations in the work vector for the inputs of the instruction (SXFunction/MXFunction) */
    ...
    /** \brief Location in the work vector for the output of the instruction (SXFunction/MXFunction) */
